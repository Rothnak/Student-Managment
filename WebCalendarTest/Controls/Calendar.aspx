<%@ Page language="c#" Codebehind="Calendar.aspx.cs" AutoEventWireup="false" Inherits="AspNetCalendarCtlTest.Calendar" %>
			...
			<table height="220" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<td>
						<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td vAlign="middle" align="right" width="45%"><asp:dropdownlist id="CboYear" runat="server" Width="70px" CssClass="cssDTPComboBox" AutoPostBack="True"></asp:dropdownlist>&nbsp;<asp:label id="LblYear" runat="server" Width="45px" CssClass="cssDTPLabel">Year</asp:label></td>
								<td vAlign="middle" align="right" width="45%"><asp:dropdownlist id="CboMonth" runat="server" Width="60px" CssClass="cssDTPComboBox" AutoPostBack="True">
				...
				<tr height="170">
					<td vAlign="top" align="center"><asp:calendar id="CdrDatePicker" runat="server" ToolTip="Select Date" Width="240px" CssClass="cssDatePickerBase"
							ShowNextPrevMonth="False" FirstDayOfWeek="Sunday" NextMonthText=" " PrevMonthText=" " Height="170px" DayNameFormat="FirstLetter">
